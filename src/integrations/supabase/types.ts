    ...
    Tables: {
      ...
      nfl_games: {
        Row: {
          ...
          boxscore_url: string | null
          date: string | null
          first_down_def: number | null
          first_down_off: number | null
          game_id: string
          game_time: string | null
          home_team: string | null
          overtime: string | null
          pass_yds_def: number | null
          pass_yds_off: number | null
          playoff: boolean | null
          pts_def: number | null
          pts_off: number | null
          result: string | null
          rush_yds_def: number | null
          rush_yds_off: number | null
          season: number | null
          to_def: number | null
          to_off: number | null
          week: number | null
          yards_def: number | null
          yards_off: number | null
        }
        Insert: {
          away_team?: string | null
          boxscore_url?: string | null
